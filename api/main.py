...
from api.routers import auth, users, invite_codes, agreements, admin, groups, students, schedules, lessons, attendances, homeworks
...
for router in [
    ...
    attendances.router, homeworks.router,
]:
