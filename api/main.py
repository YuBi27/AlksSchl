...
from api.routers import auth, users, invite_codes, agreements, admin, groups, students, schedules, lessons, attendances, homeworks, teacher_notes, broadcasts, content, stats, payments, quizzes
...
for router in [
    ...
    quizzes.router, quizzes.attempts_router, quizzes.assignments_router,
]:
